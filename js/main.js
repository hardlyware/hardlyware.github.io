(function () {
  ...
  async function loadYouTubeStats() {
    ...
    // const apiKey = import.meta.env.VITE_YOUTUBE_API_KEY || 'AIzaSyA9KhNhym3tNJvbsAQAR4bbN6rbIyBmgow';
    const apiKey = window.YOUTUBE_API_KEY || 'AIzaSyA9KhNhym3tNJvbsAQAR4bbN6rbIyBmgow';

    if (apiKey === 'AIzaSyA9KhNhym3tNJvbsAQAR4bbN6rbIyBmgow') {
